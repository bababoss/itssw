...
from TextSpotting.local_utils import establish_char_dict
...
class FeatureIO(object):
    ...
    """
    def __init__(self, char_dict_path=ops.join('/home/gpu-machine/projects/rnpd/TextSpotting/data/char_dict/char_dict.json'),
                 ord_map_dict_path=ops.join('/home/gpu-machine/projects/rnpd/TextSpotting/data/char_dict/ord_map.json')):
